...
export const TodoOptions = ({ isMobile, size, onFilterChange, onClearComplete }) => {
    ...
    return (
        ...
        {isMobile ? (
            <>
                <div className="text-dark-grayish-blue flex justify-between px-5 py-3 text-sm bg-inherit mb-5 sm:mb-0 bg-white dark:bg-very-dark-desaturated-blue">
            ...
            <div className="bg-white dark:bg-very-dark-desaturated-blue text-dark-grayish-blue flex justify-between px-5 py-3 text-sm bg-inherit mb-5">
                <span> { size} item left</span>
